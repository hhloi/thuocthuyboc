...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2015 at 06:19 PM
...
--
-- Database: `thuocthuyboc`
--

-- --------------------------------------------------------

--
-- Table structure for table `fascon_assets`
--

CREATE TABLE IF NOT EXISTS `fascon_assets` (
...
--
-- Dumping data for table `fascon_assets`
--

INSERT INTO `fascon_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `fascon_associations`
--

CREATE TABLE IF NOT EXISTS `fascon_associations` (
...
--
-- Table structure for table `fascon_banners`
--

CREATE TABLE IF NOT EXISTS `fascon_banners` (
...
--
-- Table structure for table `fascon_banner_clients`
--

CREATE TABLE IF NOT EXISTS `fascon_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `fascon_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `fascon_banner_tracks` (
...
--
-- Table structure for table `fascon_categories`
--

CREATE TABLE IF NOT EXISTS `fascon_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `fascon_categories`
--

INSERT INTO `fascon_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 353, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 353, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 353, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 353, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 353, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 353, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_contact_details`
--

CREATE TABLE IF NOT EXISTS `fascon_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `fascon_content`
--

CREATE TABLE IF NOT EXISTS `fascon_content` (
...
--
-- Dumping data for table `fascon_contentitem_tag_map`
--

INSERT INTO `fascon_contentitem_tag_map` (`type_alias`, `core_content_id`, `content_item_id`, `tag_id`, `tag_date`, `type_id`) VALUES
('com_content.article', 1, 1, 2, '2013-11-16 06:00:00', 1);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `fascon_content_frontpage` (
...
--
-- Table structure for table `fascon_content_rating`
--

CREATE TABLE IF NOT EXISTS `fascon_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `fascon_content_types`
--

CREATE TABLE IF NOT EXISTS `fascon_content_types` (
...
--
-- Dumping data for table `fascon_content_types`
--

INSERT INTO `fascon_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `fascon_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `fascon_core_log_searches` (
...
--
-- Table structure for table `fascon_extensions`
--

CREATE TABLE IF NOT EXISTS `fascon_extensions` (
...
--
-- Dumping data for table `fascon_extensions`
--

INSERT INTO `fascon_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
--
-- Table structure for table `fascon_finder_filters`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_filters` (
...
--
-- Table structure for table `fascon_finder_links`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links` (
...
--
-- Table structure for table `fascon_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms0` (
...
--
-- Table structure for table `fascon_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `fascon_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `fascon_finder_taxonomy`
--

INSERT INTO `fascon_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fascon_finder_terms`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_terms` (
...
--
-- Table structure for table `fascon_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `fascon_finder_terms_common`
--

INSERT INTO `fascon_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `fascon_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `fascon_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `fascon_finder_types`
--

CREATE TABLE IF NOT EXISTS `fascon_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `fascon_languages`
--

CREATE TABLE IF NOT EXISTS `fascon_languages` (
...
--
-- Dumping data for table `fascon_languages`
--

INSERT INTO `fascon_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_menu`
--

CREATE TABLE IF NOT EXISTS `fascon_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `fascon_menu`
--

INSERT INTO `fascon_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `fascon_menu_types`
--

CREATE TABLE IF NOT EXISTS `fascon_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `fascon_menu_types`
--

INSERT INTO `fascon_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `fascon_messages`
--

CREATE TABLE IF NOT EXISTS `fascon_messages` (
...
--
-- Table structure for table `fascon_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `fascon_messages_cfg` (
...
--
-- Table structure for table `fascon_modules`
--

CREATE TABLE IF NOT EXISTS `fascon_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `fascon_modules`
--

INSERT INTO `fascon_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `fascon_modules_menu`
--

CREATE TABLE IF NOT EXISTS `fascon_modules_menu` (
...
--
-- Dumping data for table `fascon_modules_menu`
--

INSERT INTO `fascon_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `fascon_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `fascon_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `fascon_overrider`
--

CREATE TABLE IF NOT EXISTS `fascon_overrider` (
...
--
-- Table structure for table `fascon_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `fascon_postinstall_messages` (
...
--
-- Dumping data for table `fascon_postinstall_messages`
--

INSERT INTO `fascon_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `fascon_redirect_links`
--

CREATE TABLE IF NOT EXISTS `fascon_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `fascon_schemas`
--

CREATE TABLE IF NOT EXISTS `fascon_schemas` (
...
--
-- Dumping data for table `fascon_schemas`
--

INSERT INTO `fascon_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Table structure for table `fascon_session`
--

CREATE TABLE IF NOT EXISTS `fascon_session` (
...
--
-- Table structure for table `fascon_tags`
--

CREATE TABLE IF NOT EXISTS `fascon_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `fascon_tags`
--

INSERT INTO `fascon_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 3, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 353, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(2, 1, 1, 2, 1, 'joomla', 'Joomla', 'joomla', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"tag_layout":"","tag_link_class":"label label-info","image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '', '', '{"author":"","robots":""}', 353, '2013-11-16 00:00:00', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `fascon_template_styles`
--

CREATE TABLE IF NOT EXISTS `fascon_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `fascon_template_styles`
--

INSERT INTO `fascon_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `fascon_ucm_base`
--

CREATE TABLE IF NOT EXISTS `fascon_ucm_base` (
...
--
-- Dumping data for table `fascon_ucm_base`
--

INSERT INTO `fascon_ucm_base` (`ucm_id`, `ucm_item_id`, `ucm_type_id`, `ucm_language_id`) VALUES
(1, 1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_ucm_content`
--

CREATE TABLE IF NOT EXISTS `fascon_ucm_content` (
...
--
-- Table structure for table `fascon_update_sites`
--

CREATE TABLE IF NOT EXISTS `fascon_update_sites` (
...
--
-- Dumping data for table `fascon_update_sites`
--

INSERT INTO `fascon_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
...
--
-- Table structure for table `fascon_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `fascon_update_sites_extensions` (
...
--
-- Dumping data for table `fascon_update_sites_extensions`
--

INSERT INTO `fascon_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `fascon_usergroups`
--

CREATE TABLE IF NOT EXISTS `fascon_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `fascon_usergroups`
--

INSERT INTO `fascon_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `fascon_users`
--

CREATE TABLE IF NOT EXISTS `fascon_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `fascon_users`
--

INSERT INTO `fascon_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(353, 'Super User', 'admin', 'huuloihuynh@gmail.com', '$2y$10$SdE8oHe03uklIq9chNklTeOXvGGgUwBQ87YjApBg1N0Y35R48zPoS', 0, 1, '2015-07-01 16:17:16', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_user_keys`
--

CREATE TABLE IF NOT EXISTS `fascon_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `fascon_user_notes`
--

CREATE TABLE IF NOT EXISTS `fascon_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `fascon_user_profiles`
--

CREATE TABLE IF NOT EXISTS `fascon_user_profiles` (
...
--
-- Table structure for table `fascon_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `fascon_user_usergroup_map` (
...
--
-- Dumping data for table `fascon_user_usergroup_map`
--

INSERT INTO `fascon_user_usergroup_map` (`user_id`, `group_id`) VALUES
(353, 8);

-- --------------------------------------------------------

--
-- Table structure for table `fascon_viewlevels`
--

CREATE TABLE IF NOT EXISTS `fascon_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `fascon_viewlevels`
--

INSERT INTO `fascon_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
